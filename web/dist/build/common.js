...
/***/ function(module, exports, __webpack_require__) {
	...
	var _vueValidator = __webpack_require__(8);
	...
	_vue2.default.validator('required', {
	    message: function message(field) {
	        if (_resources2.default[field]) {
	            return '请输入' + _resources2.default[field];
	        } else {
	            return '该字段是必须的';
	        }
	    },
	    check: _vue2.default.validator('required')
	});
	_vue2.default.validator('maxlength', {
	    message: function message(field, length) {
	        return '长度超过不能超过' + length;
	    },
	    check: _vue2.default.validator('maxlength')
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var utils = {
	    ...
	    get: function get(url, params, success, complete) {
	        this.ajax({
	            url: url,
	            data: params,
	            type: 'get',
	    ...
	    post: function post(url, params, success, error) {
	        this.ajax({
	            url: url,
	            data: params,
	            type: 'post',
	...
	$.ajax = function (params) {
	    ...
	    params.success = function (rs) {
	        if (rs.code == 0) {
	            ...
	            if (location.href.indexOf('/project/demo') != -1) return false;
