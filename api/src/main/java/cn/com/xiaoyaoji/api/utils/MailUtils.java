...
public class MailUtils {
    public static String sendEmail(String subject, String msg, String to) {
        try {
            ...
            email.setAuthenticator(new DefaultAuthenticator("system@xiaoyaoji.com.cn", "XYJsys123"));
            email.setSSLOnConnect(true);
            email.setFrom("system@xiaoyaoji.com.cn");
    ...
    public static String sendHtmlMail(String subject, String html, String msg, String to, String link) {
        try {
            ...
            email.setSSLOnConnect(true);
            email.addTo(to);
            email.setFrom("system@xiaoyaoji.com.cn", "小幺鸡系统通知");
            email.setSubject(subject);
